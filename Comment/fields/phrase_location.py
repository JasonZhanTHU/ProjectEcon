...
with open('../../Location/files/cities.json') as f:
    cities = json.load(f)

with open('../../Location/files/countries.json') as f:
    countries = json.load(f)

with open('../../Location/files/us_states.json') as f:
    states = json.load(f)
...
def get_region_for_country(country):
    return search_by_name(country, countries)[0]['region']
...
def phrase_region(address):
    ...
    if country is None:
        return False
    return get_region_for_country(country)
